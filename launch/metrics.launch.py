...
# Hardware car — uses hardware_params.yaml as base config
ros2 launch f1tenth_race_metrics metrics.launch.py \
    use_hardware:=true \
    ...
    node = Node(
        ...
        parameters=[
            ...
            # 2. CLI overrides — take precedence over YAML values
            {
                ...
                "race_line_path":          LaunchConfiguration("race_line_path"),
